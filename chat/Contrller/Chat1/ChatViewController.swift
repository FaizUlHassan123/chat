...
class ChatViewController: UIViewController ,UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = self.table_View.dequeueReusableCell(withIdentifier: "chatCell") as! ChatTableViewCell
        let cell2 = self.table_View.dequeueReusableCell(withIdentifier: "receiveCell") as! ChatTableViewCell
