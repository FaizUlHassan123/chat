...
class Chat2ViewController: UIViewController ,UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = self.table_View.dequeueReusableCell(withIdentifier: "chatCell") as! Chat2TableViewCell
        let cell2 = self.table_View.dequeueReusableCell(withIdentifier: "receiveCell") as! Chat2TableViewCell
...
extension Chat2ViewController: ImagePickerDelegate {
